\begin{definition}[The network adversary]
  ...
  The one box holding what no process may see: the per-sender message pools of both layers, and the corrupted set with its budget: \leandecl{PLTS.ABA.Net.netAdv}.
\end{definition}
