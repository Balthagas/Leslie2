\begin{theorem}[Substitution]
  ...
  Replacing each round's graded-agreement subsystem by its specification is a forward simulation of $\mathrm{composed}(P)$ by $\mathrm{hybrid}(P)$, \leandecl{PLTS.ABA.substSim}, and hence $\operatorname{ATD}(\mathrm{composed}(P)) \subseteq \operatorname{ATD}(\mathrm{hybrid}(P))$: \leandecl{PLTS.ABA.substitution}.
\end{theorem}
