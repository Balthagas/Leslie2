...
% A visible Lean declaration reference; \detokenize keeps underscores safe in
% text mode. The two-argument form typesets its short display name alone.
\newcommand{\leandecl}[1]{\texttt{\detokenize{#1}}}
\newcommand{\leandeclnamed}[2]{\texttt{\detokenize{#1}}}
% Pointer to a whole Lean source file, by slashed module path without extension.
\newcommand{\leanmodule}[1]{\texttt{\detokenize{#1}}}
