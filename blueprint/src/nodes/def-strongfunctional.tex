...
\begin{proof}\leanok
  ...
  The initial clause is the hypothesis, read as $\delta_{f(sys_C.init)}$ supported on $sys_A.init$, and for the step clause the coupling is the pushforward of $\mu$ along $s \mapsto (s, \delta_{f\,s})$, the abstract side answering with its single strong step read as a weak transition.
